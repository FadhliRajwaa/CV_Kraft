...
function createRequest(body: Record<string, unknown>): Request {
  return new Request(`http://localhost/api/cv/${CV_ID}/skills`, {
    method: "PATCH",
...
describe("PATCH /api/cv/[id]/skills", () => {
  beforeEach(() => {
  ...
  it("mengupdate CV.data.skills jika payload valid", async () => {
    mockAuthenticated();
    ...
    expect(payload.message).toBe("Keahlian berhasil disimpan");
