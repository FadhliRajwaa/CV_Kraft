...
function createRequest(body: Record<string, unknown>): Request {
  return new Request(`http://localhost/api/cv/${CV_ID}/projects`, {
    method: "PATCH",
...
const VALID_PAYLOAD = {
  projects: [
    {
      name: "CVKraft",
      description: "Platform pembuat CV ATS-friendly",
...
describe("PATCH /api/cv/[id]/projects", () => {
  beforeEach(() => {
  ...
  it("mengupdate CV.data.projects jika payload valid", async () => {
    mockAuthenticated();
    ...
    expect(payload.message).toBe("Proyek berhasil disimpan");
